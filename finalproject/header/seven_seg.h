...
void Write7Seg(unsigned char c) {
	...
	static const unsigned char sevenSeg_B		= 4; 		// Pin for segment B
	static const unsigned char sevenSeg_C		= 1; 		// Pin for segment C
	static const unsigned char sevenSeg_D		= 2; 		// Pin for segment D
	static const unsigned char sevenSeg_E		= 3; 		// Pin for segment E
	static const unsigned char sevenSeg_F		= 6; 		// Pin for segment F
	static const unsigned char sevenSeg_G		= 7; 		// Pin for segment G
	static const unsigned char sevenSeg_DP		= 0; 		// Pin for segment DP
